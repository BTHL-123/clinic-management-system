...
import { getBatches, importBatch } from "../../services/inventoryService";
...
export default function InventoryBatches() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!formData.medicineId || !formData.batchNumber || !formData.expiryDate || !formData.quantity || !formData.importPrice || !formData.sellingPrice) {
