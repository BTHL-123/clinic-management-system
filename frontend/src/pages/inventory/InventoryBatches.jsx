          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-extrabold text-white flex items-center gap-3 drop-shadow-md">
                <div className="bg-indigo-500/25 p-2.5 rounded-xl border border-indigo-300/20 text-indigo-200">
                  <PackageOpen size={28} />
                </div>
                Lô Thuốc & Nhập Kho
              </h1>
              <p className="text-white font-bold mt-1 drop-shadow-sm">Quản lý lô thuốc hiện tại và thực hiện nhập kho mới.</p>
            </div>
          </div>
